...
- Добавлено ожидание выполнение всех игр перед запуском нового профиля(при наличии установленного в ADSPOWER расширения Blum Auto Clicker от автора)
- Перезапуск аккаунтов, которые не удалось запустить во время основного цикла, после вполнения основного цикла.
